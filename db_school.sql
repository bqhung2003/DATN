...
--
-- Host: 127.0.0.1    Database: db_school
-- ------------------------------------------------------
...
CREATE TABLE `bookings` (
  ...
  `status` enum('pending','approved_by_lecturer','approved_by_faculty_dean','approved_by_rector','rejected') NOT NULL DEFAULT 'pending',
  `approvedByLecturerId` bigint DEFAULT NULL,
  `approvedByFacultyDeanId` bigint DEFAULT NULL,
  `approvedByRectorId` bigint DEFAULT NULL,
  `createdAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6),
  `updatedAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6),
  `deletedAt` datetime(6) DEFAULT NULL,
  `note` text,
  PRIMARY KEY (`id`),
  KEY `FK_5519d8165846e0ab2e120917b46` (`projectId`),
  KEY `FK_d774c91ca46836695dd8e66ce0e` (`studentId`),
  KEY `FK_baaf64579cf6b29f86f08c7ddde` (`approvedByLecturerId`),
  KEY `FK_e8f2fe9a992434960b226edede5` (`approvedByFacultyDeanId`),
  KEY `FK_818c59acd4be4b2936810c9fdea` (`approvedByRectorId`),
  CONSTRAINT `FK_5519d8165846e0ab2e120917b46` FOREIGN KEY (`projectId`) REFERENCES `projects` (`id`),
  CONSTRAINT `FK_818c59acd4be4b2936810c9fdea` FOREIGN KEY (`approvedByRectorId`) REFERENCES `users` (`id`),
  CONSTRAINT `FK_baaf64579cf6b29f86f08c7ddde` FOREIGN KEY (`approvedByLecturerId`) REFERENCES `users` (`id`),
  CONSTRAINT `FK_d774c91ca46836695dd8e66ce0e` FOREIGN KEY (`studentId`) REFERENCES `users` (`id`),
  CONSTRAINT `FK_e8f2fe9a992434960b226edede5` FOREIGN KEY (`approvedByFacultyDeanId`) REFERENCES `users` (`id`)
...
INSERT INTO `bookings` VALUES (1,'2025-09-24 19:00:00',16,12,'pending',NULL,NULL,NULL,'2025-09-10 00:16:30.462007','2025-09-10 00:33:50.000000','2025-09-10 00:33:50.000000',NULL),(2,'2025-09-26 19:00:00',10,12,'approved_by_rector',11,15,16,'2025-09-10 00:36:55.212420','2025-09-13 22:47:44.000000',NULL,NULL),(3,'2025-09-30 16:00:00',16,12,'approved_by_lecturer',11,NULL,NULL,'2025-09-10 00:54:08.772960','2025-09-13 21:57:56.000000',NULL,NULL),(4,'2025-09-26 15:05:00',17,12,'rejected',11,NULL,NULL,'2025-09-10 00:54:52.873933','2025-09-10 00:59:59.000000',NULL,NULL),(5,'2025-09-30 16:00:00',18,9,'pending',NULL,NULL,NULL,'2025-09-13 16:40:03.868587','2025-09-13 16:40:21.000000','2025-09-13 16:40:21.000000',NULL),(6,'2025-09-15 16:00:00',18,9,'approved_by_lecturer',11,NULL,NULL,'2025-09-13 16:40:29.307301','2025-09-13 21:57:40.000000',NULL,NULL);
...
CREATE TABLE `council_members` (
  ...
  `roleInCouncil` varchar(100) NOT NULL,
...
INSERT INTO `council_members` VALUES (1,4,'2025-08-26 22:18:59.843069',''),(1,5,'2025-08-26 22:18:59.846188',''),(1,8,'2025-08-26 22:18:59.848949',''),(2,8,'2025-08-26 22:30:15.720617',''),(2,11,'2025-08-26 22:30:15.724829',''),(14,11,'2026-04-02 16:10:39.437631','Thành viên');
...
INSERT INTO `council_projects` VALUES (1,5,'2025-08-26 22:02:07.444441'),(1,7,'2025-08-26 22:06:02.379790'),(1,8,'2025-08-26 22:02:07.449134'),(2,9,'2025-08-26 22:36:06.433607'),(8,9,'2025-09-01 22:21:32.361219'),(14,24,'2026-04-07 16:16:50.352821');
...
CREATE TABLE `councils` (
  ...
  `createdAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6),
  `updatedAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6),
  `defenseAddress` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `councils` VALUES (1,'Hội đồng 1 - CNTT 2025A','Đồ án tốt nghiệp','active',1,'2025-08-26 22:01:46.893777','2025-08-26 22:18:59.000000',NULL),(2,'Hội đồng 1 - Điện tử & Tự động hóa','Đồ án tốt nghiệp 2025 A ','active',2,'2025-08-26 22:30:15.694537','2025-08-26 22:30:15.694537',NULL),(3,'Hội đồng 1 - CNTT 2025A','Đồ án tốt nghiệp','active',1,'2025-08-26 22:01:46.893777','2025-08-26 22:18:59.000000',NULL),(4,'Hội đồng 1 - Điện tử & Tự động hóa','Đồ án tốt nghiệp 2025 A ','active',2,'2025-08-26 22:30:15.694537','2025-08-26 22:30:15.694537',NULL),(5,'Hội đồng 1 - CNTT 2025A','Đồ án tốt nghiệp','active',1,'2025-08-26 22:01:46.893777','2025-08-26 22:18:59.000000',NULL),(6,'Hội đồng 1 - Điện tử & Tự động hóa','Đồ án tốt nghiệp 2025 A ','active',2,'2025-08-26 22:30:15.694537','2025-08-26 22:30:15.694537',NULL),(7,'Hội đồng 1 - CNTT 2025A','Đồ án tốt nghiệp','active',1,'2025-08-26 22:01:46.893777','2025-08-26 22:18:59.000000',NULL),(8,'Hội đồng 1 - Điện tử & Tự động hóa','Đồ án tốt nghiệp 2025 A ','active',2,'2025-08-26 22:30:15.694537','2025-08-26 22:30:15.694537',NULL),(9,'Hội đồng 1 - CNTT 2025A','Đồ án tốt nghiệp','active',1,'2025-08-26 22:01:46.893777','2025-08-26 22:18:59.000000',NULL),(10,'Hội đồng 1 - Điện tử & Tự động hóa','Đồ án tốt nghiệp 2025 A ','active',2,'2025-08-26 22:30:15.694537','2025-08-26 22:30:15.694537',NULL),(11,'Hội đồng 1 - CNTT 2025A','Đồ án tốt nghiệp','active',1,'2025-08-26 22:01:46.893777','2025-08-26 22:18:59.000000',NULL),(12,'Hội đồng 1 - Điện tử & Tự động hóa','Đồ án tốt nghiệp 2025 A ','active',2,'2025-08-26 22:30:15.694537','2025-08-26 22:30:15.694537',NULL),(14,'Hội đồng chấm điểm','Hội đồng chấm điểm','active',11,'2026-04-02 16:03:29.590360','2026-04-02 16:03:29.590360','Hội đồng chấm điểm');
...
INSERT INTO `majors` VALUES (1,1,'IT1','Khoa học máy tính','2025-08-21 07:45:31.719365','2025-09-05 01:00:09.866574','Ngành học: Khoa học máy tính | Computer Science',1,1),(2,1,'IT2','Công nghê phần mềm','2025-08-23 21:29:41.664092','2025-09-05 01:00:09.866574','Công nghê phần mềm',1,1),(3,2,'ME1','Điện tử số','2025-08-23 22:39:40.378461','2025-09-05 01:00:09.866574','Điện tử số',1,1),(4,2,'ME2','Tự động hóa','2025-08-23 22:39:59.046418','2025-09-05 01:00:09.866574','Tự động hóa',1,1),(5,2,'IT6','Mạng máy tính','2025-09-01 14:51:46.559280','2025-09-05 01:00:09.866574','Mạng máy tính',1,1),(6,5,'AI','Trí tuệ nhân tạo','2025-09-01 21:14:20.589525','2025-09-05 01:00:09.866574','',1,1),(7,11,'AI1','Trí tuệ nhân tạo 1','2025-09-01 21:49:57.352049','2026-04-02 14:52:40.973684','',1,1),(8,2,'ME8','Tự động hóa','2025-08-23 22:39:59.046418','2025-09-05 01:00:09.866574','Tự động hóa',1,1),(9,2,'IT9','Mạng máy tính','2025-09-01 14:51:46.559280','2025-09-05 01:00:09.866574','Mạng máy tính',1,1),(10,5,'AI10','Trí tuệ nhân tạo','2025-09-01 21:14:20.589525','2025-09-05 01:00:09.866574','',1,1),(11,3,'AI11','Trí tuệ nhân tạo 1','2025-09-01 21:49:57.352049','2025-09-05 01:00:09.866574','',1,1);
...
CREATE TABLE `projects` (
  ...
  `lastMilestoneSubmissionId` bigint DEFAULT NULL,
  PRIMARY KEY (`id`),
  ...
  KEY `FK_be42c946d034d207637ef6a7a36` (`lastMilestoneSubmissionId`),
  ...
  CONSTRAINT `FK_be42c946d034d207637ef6a7a36` FOREIGN KEY (`lastMilestoneSubmissionId`) REFERENCES `milestone_submissions` (`id`),
...
INSERT INTO `projects` VALUES (1,'P0000001','Cải tiến mô hình YOLOv8 cho phát hiện đối tượng trong điều kiện ánh sáng yếu','Cải tiến mô hình YOLOv8 cho phát hiện đối tượng trong điều kiện ánh sáng yếu.','Cải tiến mô hình YOLOv8 cho phát hiện đối tượng trong điều kiện ánh sáng yếu.','Cải tiến mô hình YOLOv8 cho phát hiện đối tượng trong điều kiện ánh sáng yếu.','Cải tiến mô hình YOLOv8 cho phát hiện đối tượng trong điều kiện ánh sáng yếu.','vvvv','2025-01-01','2025-01-09','approved_by_lecturer','undergraduate',0.00,1,1,1,1,4,1,'2025-08-21 08:24:38.562871','2025-09-06 18:00:12.573103',NULL,NULL),(4,'P0000002','Ứng dụng Transformer trong dịch tự động Anh – Việt','Ứng dụng Transformer trong dịch tự động Anh – Việt','Ứng dụng Transformer trong dịch tự động Anh – Việt.','Ứng dụng Transformer trong dịch tự động Anh – Việt.','Ứng dụng Transformer trong dịch tự động Anh – Việt.','Ứng dụng Transformer trong dịch tự động Anh – Việt.','2025-01-01','2025-01-09','pending','graduate',0.00,1,1,1,1,5,2,'2025-08-21 09:10:57.100312','2025-08-26 22:22:57.000000',NULL,NULL),(5,'P0000003','Nghiên cứu học sâu cho tóm tắt văn bản tiếng Việt','Machine Learning','Machine Learning','Machine Learning','Machine Learning','Machine Learning','2025-01-01','2025-12-31','completed','undergraduate',0.00,1,1,1,1,5,3,'2025-08-22 21:49:53.085355','2025-08-26 22:22:42.354037',NULL,NULL),(6,'P0000004','Phát triển chatbot tiếng Việt dựa trên mô hình Seq2Seq kết hợp Attention','Quan ly khach san','Quan ly khach san','Quan ly khach san','Quan ly khach san','Quan ly khach san','2025-01-01','2025-12-31','pending','undergraduate',0.00,1,1,1,1,4,3,'2025-08-22 21:57:54.911068','2025-08-26 22:22:42.353425',NULL,NULL),(7,'P0000005','Ứng dụng học sâu trong phát hiện gian lận thẻ tín dụng','Ứng dụng học sâu trong phát hiện gian lận thẻ tín dụng.','Ứng dụng học sâu trong phát hiện gian lận thẻ tín dụng.','Dự án Smart City','Dự án Smart City','Dự án Smart City','2025-01-01','2025-12-01','approved_by_lecturer','undergraduate',0.00,1,1,2,7,8,3,'2025-08-23 22:09:33.968083','2025-09-06 18:00:12.574074',9.50,NULL),(8,'P0000006','Nghiên cứu và cải tiến mô hình học sâu cho chuyển văn bản thành giọng nói tiếng Việt tự nhiên','Nghiên cứu AI trong lĩnh vực y tế 0010210212','Nghiên cứu AI trong lĩnh vực y tế','Nghiên cứu AI trong lĩnh vực y tế','Nghiên cứu AI trong lĩnh vực y tế','Nghiên cứu AI trong lĩnh vực y tế','2025-01-01','2025-12-30','approved_by_lecturer','undergraduate',0.00,1,1,2,9,4,1,'2025-08-23 22:25:46.201314','2025-09-06 18:00:12.574774',NULL,NULL),(9,'P0000008','Ứng dụng BERT trong phân tích cảm xúc từ bình luận mạng xã hội','Ứng dụng BERT trong phân tích cảm xúc từ bình luận mạng xã hội','Ứng dụng BERT trong phân tích cảm xúc từ bình luận mạng xã hội','Ứng dụng BERT trong phân tích cảm xúc từ bình luận mạng xã hội','Ứng dụng BERT trong phân tích cảm xúc từ bình luận mạng xã hội','Ứng dụng BERT trong phân tích cảm xúc từ bình luận mạng xã hội','2025-01-01','2025-12-01','completed','undergraduate',0.00,2,2,3,10,5,1,'2025-08-26 22:32:24.988501','2025-08-26 22:38:35.000000',8.75,NULL),(10,'P0000088','Luận án tiến sĩ về ứng dụng AI trong y tế','Luận án tiến sĩ về ứng dụng AI trong y tế','Luận án tiến sĩ về ứng dụng AI trong y tế','Luận án tiến sĩ về ứng dụng AI trong y tế','Luận án tiến sĩ về ứng dụng AI trong y tế','Luận án tiến sĩ về ứng dụng AI trong y tế','2025-01-01','2025-12-31','approved_by_lecturer','research',0.00,1,1,1,12,11,4,'2025-08-26 22:45:42.760742','2025-09-06 18:00:12.575481',NULL,NULL),(11,'P0000011','Nghiên cứu và cải tiến mô hình học sâu cho chuyển văn bản thành giọng nói tiếng Việt tự nhiên','Nghiên cứu AI trong lĩnh vực y tế 0010210212','Nghiên cứu AI trong lĩnh vực y tế','Nghiên cứu AI trong lĩnh vực y tế','Nghiên cứu AI trong lĩnh vực y tế','Nghiên cứu AI trong lĩnh vực y tế','2025-01-01','2025-12-30','approved_by_lecturer','undergraduate',0.00,1,1,2,9,4,1,'2025-08-23 22:25:46.201314','2025-09-06 18:00:12.576490',NULL,NULL),(12,'P0000012','Ứng dụng BERT trong phân tích cảm xúc từ bình luận mạng xã hội','Ứng dụng BERT trong phân tích cảm xúc từ bình luận mạng xã hội','Ứng dụng BERT trong phân tích cảm xúc từ bình luận mạng xã hội','Ứng dụng BERT trong phân tích cảm xúc từ bình luận mạng xã hội','Ứng dụng BERT trong phân tích cảm xúc từ bình luận mạng xã hội','Ứng dụng BERT trong phân tích cảm xúc từ bình luận mạng xã hội','2025-01-01','2025-12-01','completed','undergraduate',0.00,2,2,3,10,5,1,'2025-08-26 22:32:24.988501','2025-08-26 22:38:35.000000',8.75,NULL),(13,'P0000013','Luận án tiến sĩ về ứng dụng AI trong y tế','Luận án tiến sĩ về ứng dụng AI trong y tế','Luận án tiến sĩ về ứng dụng AI trong y tế','Luận án tiến sĩ về ứng dụng AI trong y tế','Luận án tiến sĩ về ứng dụng AI trong y tế','Luận án tiến sĩ về ứng dụng AI trong y tế','2025-01-01','2025-12-31','in_progress','research',0.00,1,1,1,12,11,4,'2025-08-26 22:45:42.760742','2025-09-06 18:04:26.000000',NULL,NULL),(16,'AAAAAAAAAAA','BBBBBBBBBBB','AAAAAAAAAAA','AAAAAAAAAAA','AAAAAAAAAAA','AAAAAAAAAAA','AAAAAAAAAAA','2025-01-01','2025-03-11','approved_by_lecturer','undergraduate',0.00,11,10,11,12,11,4,'2025-09-06 17:10:54.986413','2025-09-06 22:08:32.000000',NULL,NULL),(17,'CCCCCCCCCCCC','DDĐĐDĐ','DDĐĐDĐ','DDĐĐDĐ','DDĐĐDĐ','DDĐĐDĐ','DDĐĐDĐDDĐĐDĐ','2025-01-01','2025-12-12','pending','undergraduate',0.00,11,10,11,12,11,3,'2025-09-06 22:17:46.458463','2025-09-06 22:17:46.458463',NULL,NULL),(18,'P00000012','Hê thống bán hàng tự động','Hê thống bán hàng tự động','Hê thống bán hàng tự động','Hê thống bán hàng tự động','Hê thống bán hàng tự động','Hê thống bán hàng tự động','2025-01-01','2025-12-12','in_progress','undergraduate',0.00,11,10,11,9,11,4,'2025-09-13 15:53:18.897020','2025-09-13 21:09:00.000000',NULL,NULL),(19,'draf','draf','draf','draf','draf','draf','draf','2026-01-01','2026-12-31','draft','research',0.00,11,11,7,1,11,1,'2026-04-01 14:54:03.796544','2026-04-01 14:56:27.974982',NULL,NULL),(20,'pending','pending','pending','pending','pending','pending','pending','2026-01-01','2026-12-31','pending','research',0.00,11,11,7,1,11,1,'2026-04-01 14:54:03.796544','2026-04-01 14:56:27.974982',NULL,NULL),(21,'lecturer','approved_by_lecturer','approved_by_lecturer','approved_by_lecturer','approved_by_lecturer','approved_by_lecturer','approved_by_lecturer','2026-01-01','2026-12-31','approved_by_lecturer','research',0.00,11,11,7,1,11,1,'2026-04-01 14:54:03.796544','2026-04-01 14:56:27.974982',NULL,NULL),(22,'faculty_dean','approved_by_faculty_dean','approved_by_faculty_dean','approved_by_faculty_dean','approved_by_faculty_dean','approved_by_faculty_dean','approved_by_faculty_dean','2026-01-01','2026-12-31','approved_by_faculty_dean','research',0.00,11,11,7,1,11,1,'2026-04-01 14:54:03.796544','2026-04-01 14:56:27.974982',NULL,NULL),(23,'rector','approved_by_rector','approved_by_rector','approved_by_rector','approved_by_rector','approved_by_rector','approved_by_rector','2026-01-01','2026-12-31','in_progress','research',0.00,11,11,7,1,11,1,'2026-04-01 14:54:03.796544','2026-04-02 14:41:00.000000',NULL,NULL),(24,'in_progress','in_progress','in_progress','in_progress','in_progress','in_progress','in_progress','2026-01-01','2026-12-31','in_progress','research',0.00,11,11,7,1,11,1,'2026-04-01 14:54:03.796544','2026-04-01 14:56:27.974982',NULL,NULL),(25,'completed','completed','completed','completed','completed','completed','completed','2026-01-01','2026-12-31','completed','research',0.00,11,11,7,1,11,1,'2026-04-01 14:54:03.796544','2026-04-01 14:56:27.974982',NULL,NULL),(26,'cancelled','cancelled','cancelled','cancelled','cancelled','cancelled','cancelled','2026-01-01','2026-12-31','cancelled','research',0.00,11,11,7,1,11,1,'2026-04-01 14:54:03.796544','2026-04-01 14:56:27.974982',NULL,NULL);
...
CREATE TABLE `terms` (
  ...
  KEY `FK_e47d1cc89d00b393a59aed32b08` (`academicYearId`),
  CONSTRAINT `FK_e47d1cc89d00b393a59aed32b08` FOREIGN KEY (`academicYearId`) REFERENCES `academic_years` (`id`)
...
INSERT INTO `terms` VALUES (1,'2026A','Bảo vệ đồ án tốt nghiệp 2026A','2026-01-01','2026-12-31','Bảo vệ đồ án tốt nghiệp 2026A','open','2025-08-21 04:57:02.166630','2026-03-31 15:48:23.810114',1),(2,'2025-NCKH-A','Nghiên cứu khoa học 2025A','2025-01-01','2025-01-09','Nghiên cứu khoa học cấp trường','open','2025-08-21 07:34:49.057494','2025-09-10 22:27:12.282810',1),(3,'DA2025B','Bảo vệ đồ án tốt nghiệp 2025B','2025-01-01','2025-12-31','Bảo vệ đồ án 2025B','open','2025-08-22 21:36:45.234659','2025-09-10 22:27:12.283561',1),(4,'E0000028','Bảo vệ Luận án tiến sĩ (1)','2025-02-01','2025-12-31','Bảo vệ Luận án tiến sĩ 2025','open','2025-08-26 22:40:53.056581','2025-09-10 22:27:12.284578',1),(5,'2025A5','Bảo vệ đồ án tốt nghiệp 2025A','2025-01-01','2025-02-07','Bảo vệ đồ án tốt nghiệp 2025A','open','2025-08-21 04:57:02.166630','2025-09-10 22:27:12.285272',1),(6,'2025-NCKH-A6','Nghiên cứu khoa học 2025A','2025-01-01','2025-01-09','Nghiên cứu khoa học cấp trường','open','2025-08-21 07:34:49.057494','2025-08-21 09:20:57.000000',NULL),(7,'DA2025B7','Bảo vệ đồ án tốt nghiệp 2025B','2025-01-01','2025-12-31','Bảo vệ đồ án 2025B','open','2025-08-22 21:36:45.234659','2025-08-23 22:41:00.000000',NULL),(8,'E00000288','Bảo vệ Luận án tiến sĩ (2)','2025-01-01','2025-07-31','Bảo vệ Luận án tiến sĩ 2025','open','2025-08-26 22:40:53.056581','2025-09-06 17:37:26.000000',NULL),(9,'2025A9','Bảo vệ đồ án tốt nghiệp 2025A','2025-01-01','2025-02-07','Bảo vệ đồ án tốt nghiệp 2025A','open','2025-08-21 04:57:02.166630','2025-08-21 07:36:17.000000',NULL),(10,'2025-NCKH-A10','Nghiên cứu khoa học 2025A','2025-01-01','2025-01-09','Nghiên cứu khoa học cấp trường','open','2025-08-21 07:34:49.057494','2025-08-21 09:20:57.000000',NULL),(11,'DA2025B11','Bảo vệ đồ án tốt nghiệp 2025B','2025-01-01','2025-12-31','Bảo vệ đồ án 2025B','open','2025-08-22 21:36:45.234659','2025-08-23 22:41:00.000000',NULL),(12,'E000002812','Bảo vệ Luận án tiến sĩ (3)','2025-01-01','2025-07-31','Bảo vệ Luận án tiến sĩ 2025','open','2025-08-26 22:40:53.056581','2025-09-06 17:37:42.000000',NULL),(13,'E00212','SK năm 2023','2023-01-01','2025-01-12','SK năm 2023','open','2025-09-13 18:54:00.449744','2025-09-13 18:54:00.449744',2);
...
$2b$10$8G.qqGfIKyf3TARyXaVSMOuMWiDJVSc6Lf9JIHy3.vNQC.xNvwlbi','2025-09-13 22:07:41.194652','2025-09-13 22:07:41.194652',1,1,2),(16,'00000151','Phòng NCKH',NULL,'093112121212','phongnckh1@gmail.com','$2b$10$qE875KK01YteKyrSQ.zNg.Q9VHZl08uZ.N2W3SCLgBe24fDNPK1j2','2025-09-13 22:35:18.351351','2026-03-29 09:38:38.371103',1,1,2),(17,'TRGKHOA5','Trưởng khoa 5',NULL,'0978478178','truongkhoa5@gmail.com','$2b$10$q6NG/KIfVk6TFC3Kc.r/ouTpSvHn1yEy9W/zjDdAqKtXcPOh6uKES','2026-04-02 14:53:38.154185','2026-04-02 14:53:38.154185',11,11,7),(18,'PNCKH5','Phòng NCKH 5',NULL,'0987929626','phongnckh5@gmail.com','$2b$10$Q5UEHn9htMA6lQxUUcosXu9.nPKBI9GRJr.WFaGHvMiMMCPrCzYWW','2026-04-02 14:55:50.498862','2026-04-02 14:55:50.498862',11,11,7),(27,'TEST07','TEST',NULL,'0123456789','test07@gmail.com','$2b$10$Q5UEHn9htMA6lQxUUcosXu9.nPKBI9GRJr.WFaGHvMiMMCPrCzYWW','2026-04-02 14:55:50.498862','2026-04-06 15:52:00.137235',11,11,7),(28,'TEST08','TEST',NULL,'0123456789','test08@gmail.com','$2b$10$Q5UEHn9htMA6lQxUUcosXu9.nPKBI9GRJr.WFaGHvMiMMCPrCzYWW','2026-04-02 14:55:50.498862','2026-04-02 14:55:50.498862',11,11,7),(29,'TEST09','TEST',NULL,'0123456789','test09@gmail.com','$2b$10$Q5UEHn9htMA6lQxUUcosXu9.nPKBI9GRJr.WFaGHvMiMMCPrCzYWW','2026-04-02 14:55:50.498862','2026-04-02 14:55:50.498862',11,11,7),(30,'TEST10','TEST',NULL,'0123456789','test10@gmail.com','$2b$10$Q5UEHn9htMA6lQxUUcosXu9.nPKBI9GRJr.WFaGHvMiMMCPrCzYWW','2026-04-02 14:55:50.498862','2026-04-02 14:55:50.498862',11,11,7),(31,'TEST11','TEST',NULL,'0123456789','test11@gmail.com','$2b$10$Q5UEHn9htMA6lQxUUcosXu9.nPKBI9GRJr.WFaGHvMiMMCPrCzYWW','2026-04-02 14:55:50.498862','2026-04-02 14:55:50.498862',11,11,7),(32,'TEST12','TEST',NULL,'0123456789','test12@gmail.com','$2b$10$Q5UEHn9htMA6lQxUUcosXu9.nPKBI9GRJr.WFaGHvMiMMCPrCzYWW','2026-04-02 14:55:50.498862','2026-04-02 14:55:50.498862',11,11,7),(33,'TEST13','TEST',NULL,'0123456789','test13@gmail.com','$2b$10$Q5UEHn9htMA6lQxUUcosXu9.nPKBI9GRJr.WFaGHvMiMMCPrCzYWW','2026-04-02 14:55:50.498862','2026-04-02 14:55:50.498862',11,11,7),(34,'TEST14','TEST',NULL,'0123456789','test14@gmail.com','$2b$10$Q5UEHn9htMA6lQxUUcosXu9.nPKBI9GRJr.WFaGHvMiMMCPrCzYWW','2026-04-02 14:55:50.498862','2026-04-02 14:55:50.498862',11,11,7);
...
-- Dump completed on 2026-04-07 23:17:14
